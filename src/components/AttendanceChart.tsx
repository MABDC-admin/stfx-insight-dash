          ...
          <AreaChart data={data}>
            <defs>
              ...
              <linearGradient id="targetGrad" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="hsl(180, 70%, 45%)" stopOpacity={0.15} />
                <stop offset="100%" stopColor="hsl(180, 70%, 45%)" stopOpacity={0} />
              </linearGradient>
            </defs>
            ...
            <Area
              ...
              activeDot={{ r: 5, fill: "hsl(60, 90%, 55%)", stroke: "hsl(60, 90%, 55%)", strokeWidth: 2 }}
            />
          </AreaChart>
        </ResponsiveContainer>
      </div>
